...
from src.exceptions import FileCorruptedError, FileTooLargeError, UnsupportedFormatError
from src.logger import logger_manager
from src.scan_detector import ScanDetector
...
class DocumentParser:
    ...
    def _split_clauses(text: str) -> list[Clause]:
        ...
        """
        from src.structure.clause_patterns import CLAUSE_PATTERNS, CLAUSE_TITLE_KEYWORDS
    ...
    def _get_layout_engine(self):
        ...
        if self._layout_engine is None:
            try:
                from src.layout.engine import get_layout_engine
    ...
    def _build_enhanced_from_ocr(
        ...
        try:
            from src.structure.clause_tree import build_clause_tree_from_blocks
